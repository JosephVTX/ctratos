...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'numero_cuenta_gjg' => 'required|numeric|digits_between:1,15',
            'nombre_cuenta_gjg' => 'required|string|max:255',
    ...
    public function messages(): array
    {
        return [
            ...
            'numero_cuenta_gjg.required' => 'El campo es requerido',
            'numero_cuenta_gjg.digits_between' => 'El campo debe estar entre 1 y 15 dígitos',
            'nombre_cuenta_gjg.required' => 'El campo es requerido',
